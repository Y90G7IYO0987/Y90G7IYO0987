[![Header](https://github.com/Y90G7IYO0987/Y90G7IYO0987/blob/main/assets/Ats-Profi-Banner.png)](https://www.youtube.com/@atsprofi8486)

# 👋 Hi, I'm - Timur
> *"I build worlds, I write code, sometimes I sleep"*

---

## 🧠 About me
- 🎮 I'm developing an **MMORPG on Unity + C#**.
- 🔧 I love clean code architecture, interfaces, and thoughtful systems.
- 📚 I am constantly learning - I am self-taught.
- 🧩 Developer at **luau (Roblox Studio)**, switched to a professional engine.
- 🤖I write bots in python, and sometimes I dabble in Data Science.
...
### 🔹 Project Provines
> ** MMORPG in the fantasy style on Unity.
- 🗺️ An open world with biomes, NPCs and bosses.
- ⚔️ Combat system, stamina, inventory.
- 🧠 Clean architecture: interfaces, SO, separation of logic from visual.
- 🛠️ **Stack:** Unity, C#, URP, NavMesh, ScriptableObjects, Input System.
